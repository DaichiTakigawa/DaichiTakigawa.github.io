    ...
    <Nav className="navbar">
      ...
      <div className={`navbar-menu ${state.expand ? "is-active" : ""}`}>
        <div className="navbar-start">
          <Link
            className={`navbar-item ${currentPage === "Home" ? "is-active" : ""}`}
            to="/"
          >
            Home
          </Link>
          <Link
            className={`navbar-item ${currentPage === "Blog" ? "is-active" : ""}`}
            to="/blog/"
          >
            Blog
          </Link>
          <Link
            className={`navbar-item ${currentPage === "About" ? "is-active" : ""}`}
            to="/about/"
          >
            About
          </Link>
          <Link
            className={`navbar-item ${currentPage === "Contact" ? "is-active" : ""}`}
            to="/contact/"
          >
            Contact
          </Link>

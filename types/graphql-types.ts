...
export type BaseSiteDataQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type BaseSiteDataQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'description' | 'title'>> }> };
